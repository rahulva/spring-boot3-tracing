...
// * the License.
// */
//package org.example.tracing.filter;
//
...
//     */
//    public static final String SPAN_DECORATORS = org.example.tracing.filter.TracingFilter.class.getName() + ".spanDecorators";
//    /**
//     * Use as a key of {@link ServletContext#setAttribute(String, Object)} to skip pattern
//     */
//    public static final String SKIP_PATTERN = org.example.tracing.filter.TracingFilter.class.getName() + ".skipPattern";
//
//    /**
//     * Used as a key of {@link HttpServletRequest#setAttribute(String, Object)} to inject server span context
//     */
//    public static final String SERVER_SPAN_CONTEXT = org.example.tracing.filter.TracingFilter.class.getName() + ".activeSpanContext";
//
